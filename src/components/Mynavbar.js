...
function Mynavbar() {
  return (
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 my-2 mx-2 my-h-font">
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto mx-2 mt-2">
        ...
        <Link class="me-3 py-2 text-dark text-decoration-none" to="/about">About</Link>
